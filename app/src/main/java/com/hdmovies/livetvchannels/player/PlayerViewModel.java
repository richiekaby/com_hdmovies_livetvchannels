...
import com.hdmovies.livetvchannels.item.Subtitle;
...
//        notifyPropertyChanged(BR.pausable);
    ...
    private void setLoadingComplete(boolean complete) {
        ...
        notifyPropertyChanged(com.hdmovies.livetvchannels.BR.loadingComplete);
    }
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        ...
        if (playbackState ==  Player.STATE_BUFFERING ){
            isLoadingNow =  true;
            notifyPropertyChanged(com.hdmovies.livetvchannels.BR.loaidingNow);
        }
